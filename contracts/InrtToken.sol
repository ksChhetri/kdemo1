...
contract BlackList is Ownable {
    ...
    /////// Getter to allow the same blacklist to be used also by other contracts (including upgraded Inrt) ///////
...
contract InrtToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function InrtToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
